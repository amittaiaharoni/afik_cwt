<?
	class manufacturer_factory extends base_factory{
//////////////////////////////////////////////////////////////////////////
//	BASIC FUNCTIONALITY		
		const db_table_name = "manufacturers";
		const instance_class_name = "manufacturer";		
		const cont_class_name = "manufacturer_controller";
...
//////////////////////////////////////////////////////////////////////////////////////
	...
	class manufacturer extends base_data_object{
...
//////////////////////////////////////////////////////////////////////////////////////
	...
	class manufacturer_view extends view_abstract{
				
		public function __construct($file_path) {
			global $is_admin;
			
			$this->url_page_name = ($is_admin?"admin_":"") . "manufacturers";
			$this->object_class_name = "manufacturer";
...
//////////////////////////////////////////////////////////////////////////////////////
	...
	class manufacturer_controller extends controller_abstract{
		...
		public function __construct() {
			...
			$this->url_page_name = ($is_admin?"admin_":"") . "manufacturers";
			$this->object_class_name = "manufacturer";
			$this->view_class_name = "manufacturer_view";

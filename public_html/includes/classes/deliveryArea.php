<?
	class deliveryArea_factory extends base_factory{
//////////////////////////////////////////////////////////////////////////
//	BASIC FUNCTIONALITY		
		const db_table_name = "delivery_areas";
		const instance_class_name = "deliveryArea";		
		const cont_class_name = "deliveryArea_controller";
...
//////////////////////////////////////////////////////////////////////////////////////
	...
	class deliveryArea extends base_data_object{
...
//////////////////////////////////////////////////////////////////////////////////////
	...
	class deliveryArea_view extends view_abstract{
				
		public function __construct($file_path) {
			global $is_admin;
			
			$this->url_page_name = ($is_admin?"admin_":"") . "delivery_areas";
			$this->object_class_name = "deliveryArea";
...
//////////////////////////////////////////////////////////////////////////////////////
	...
	class deliveryArea_controller extends controller_abstract{
		...
		public function __construct() {
			...
			$this->url_page_name = ($is_admin?"admin_":"") . "delivery_areas";
			$this->object_class_name = "deliveryArea";
			$this->view_class_name = "deliveryArea_view";

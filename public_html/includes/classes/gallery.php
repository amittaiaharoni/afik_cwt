<?
	class gallery_factory extends base_factory{
//////////////////////////////////////////////////////////////////////////
//	BASIC FUNCTIONALITY		
		const db_table_name = "galleries";
		const instance_class_name = "gallery";		
		const cont_class_name = "gallery_controller";
...
/////////////////////////////////////////////////////////////////////////			
	...
	class gallery extends base_data_object{
		...
		public function get_images(){
			$images = $this->data->galleryImage->get_by_column("gal_id", $this->id);
			return $images;
		}
	}
	...
	class gallery_view extends view_abstract{
		...
		public function __construct($file_path) {
			...
			$this->url_page_name = ($is_admin?"admin_":"") . "galleries";
			$this->object_class_name = "gallery";
	...
	class gallery_controller extends controller_abstract{
		...
		public function __construct() {
			...
			$this->url_page_name = ($is_admin?"admin_":"") . "galleries";
			$this->object_class_name = "gallery";
			$this->view_class_name = "gallery_view";

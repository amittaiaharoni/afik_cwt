<?
	class newsletter_factory extends base_factory{
//////////////////////////////////////////////////////////////////////////
//	BASIC FUNCTIONALITY		
		const db_table_name = "newsletter";
		const instance_class_name = "newsletter";		
		const cont_class_name = "newsletter_controller";
...
//////////////////////////////////////////////////////////////////////////////////////
	...
	class newsletter extends base_data_object{
...
//////////////////////////////////////////////////////////////////////////////////////
	...
	class newsletter_view extends view_abstract{
				
		public function __construct($file_path) {
			global $is_admin;
			
			$this->url_page_name = ($is_admin?"admin_":"") . "newsletter";
			$this->object_class_name = "newsletter";
...
//////////////////////////////////////////////////////////////////////////////////////
	...
	class newsletter_controller extends controller_abstract{
		...
		public function __construct() {
			...
			$this->url_page_name = ($is_admin?"admin_":"") . "newsletter";
			$this->object_class_name = "newsletter";
			$this->view_class_name = "newsletter_view";
			...
			$this->dt_columns = array(
				...
				array( 'db' => 'email', 'dt' => 'email',			'path' => "email")

...
<div id="page_wraper" class="container-fluid" style="position: relative;">
			...
			<div class="panel-body">
				<div class="form">
					<form id="formAddEditNewRow" method="post" action="" enctype="multipart/form-data"  role="form">
						...
						<div class="form-group" >
							<div class="col-md-12">
								<label for="sale_prod1">הנחה למוצר 1</label>
								<input type="text" class="form-control" id="sale_prod1" name="sale_prod1" placeholder="הנחה למוצר 1" value="<?=$this->get_edited_data("sale_prod1")?>">
							</div>
						</div>
						<div style="clear: both;"></div>
						<div class="form-group" >
							<div class="col-md-12">
								<label for="sale_prod2">הנחה למוצר 2</label>
								<input type="text" class="form-control" id="sale_prod2" name="sale_prod2" placeholder="הנחה למוצר 2" value="<?=$this->get_edited_data("sale_prod2")?>">
							</div>
						</div>
						<div style="clear: both;"></div>
						<div class="form-group" >
							<div class="col-md-12">
								<label for="sale_prod3">הנחה למוצר 3</label>
								<input type="text" class="form-control" id="sale_prod3" name="sale_prod3" placeholder="הנחה למוצר 3" value="<?=$this->get_edited_data("sale_prod3")?>">
							</div>
						</div>
						<div style="clear: both;"></div>
						<div class="form-group" >
							<div class="col-md-12">
								<label for="sale_prod4">הנחה למוצר 4</label>
								<input type="text" class="form-control" id="sale_prod4" name="sale_prod4" placeholder="הנחה למוצר 4" value="<?=$this->get_edited_data("sale_prod4")?>">
							</div>
						</div>
						<div style="clear: both;"></div>
						<div class="form-group" >
							<div class="col-md-12">
								<label for="sale_prod5">הנחה למוצר 5</label>
								<input type="text" class="form-control" id="sale_prod5" name="sale_prod5" placeholder="הנחה למוצר 5" value="<?=$this->get_edited_data("sale_prod5")?>">
							</div>
						</div>
						<div style="clear: both;"></div>
						<div class="form-group" >
							<div class="checkbox">
								<label>
									...
									<input type="checkbox" name="is_active" value="1" <?=$this->is_checked("is_active",1)?>> 
									מופעל
								</label>
							</div>
						</div>
	...
	<div id="" class="col-md-6">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="panel-title">רשימת מבצעי כמות מוצרים</h3>
			</div>
			<div class="panel-body">
				<div class="table">

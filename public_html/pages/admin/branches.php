...
<div id="page_wraper" class="container-fluid" style="position: relative;">
			...
			<div class="panel-body">
				<div class="form">
					<form id="formAddEditNewRow" method="post" action="" enctype="multipart/form-data"  role="form">
						...
						<div class="form-group" >
							<label for="open_hours">שעות פתיחה</label>
							<textarea name="open_hours" id="open_hours" class="form-control editor"><?=$this->get_edited_data("open_hours")?></textarea>
						</div>		
						<div class="form-group" >
	...
	<div id="" class="col-md-5">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="panel-title">רשימת סניפים</h3>
			</div>
			<div class="panel-body">
				<div class="table">

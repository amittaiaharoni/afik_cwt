...
<div id="page_wraper" class="container-fluid" style="position: relative;">
			...
			<div class="panel-body">
				<div class="form form-horizontal">
					<form id="formAddEditNewRow" method="post" action="" enctype="multipart/form-data"  role="form">
						...
						<div class="form-group" >
							<label for="barcode">בארקוד</label>
							<input type="text" class="form-control" id="barcode" name="barcode" placeholder="בארקוד" value="<?=$this->get_edited_data("barcode")?>">
						</div>
						<div class="form-group" >
							<label for="pack_quantity">כמות באריזה</label>
							<input type="text" class="form-control" id="pack_quantity" name="pack_quantity" placeholder="כמות באריזה" value="<?=$this->get_edited_data("pack_quantity")?>">
						</div>
						<div class="form-group" >
						...
						<input type="hidden" name="prod_id" value="<?=(int)$_GET["prod_id"]?>"/>
	...
	<div id="" class="col-md-8">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="panel-title">רשימת ברקודים</h3>
			</div>
			<div class="panel-body">
				<div class="table">

...
<div id="page_wraper" class="container-fluid" style="position: relative;">
			...
			<div class="panel-body">
				<div class="form">
					<form id="formAddEditNewRow" method="post" action="" enctype="multipart/form-data"  role="form">
						...
						<div class="form-group" >
							<label for="minimal_order_amount">מינימום הזמנה</label>
							<input type="text" class="form-control" id="minimal_order_amount" name="minimal_order_amount" placeholder="מינימום הזמנה" value="<?=$this->get_edited_data("minimal_order_amount")?>">
						</div>
						<div class="form-group" >
							<label for="free_delivery_from">משלוח חינם החל מ</label>
							<input type="text" class="form-control" id="free_delivery_from" name="free_delivery_from" placeholder="משלוח חינם החל מ" value="<?=$this->get_edited_data("free_delivery_from")?>">
						</div>
	...
	<div id="" class="col-md-5">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="panel-title">רשימת אזורי משלוח</h3>
			</div>
			<div class="panel-body">
				<div class="table">

...
<div id="page_wraper" class="container-fluid" style="position: relative;">
			...
			<div class="panel-body">
				<div class="form">
					<form id="formAddEditNewRow" method="post" action="" enctype="multipart/form-data"  role="form">
							...
							<div class="col-md-4">
								<div class="checkbox">
									<label>
										...
										<input type="checkbox" name="active" value="1" <?=$this->is_checked("active",1)?>>
										להציג שבלונות מיילים
									</label>
								</div>
							</div>
						</div>
						...
						<!--
						<button name="send_waiting_mails" type="submit" class="btn btn-warning" style="margin-top: 25px;">
							שלח מיילים בהמתנה
						</button>
						-->
					</form>
	...
	<div id="" class="col-md-5">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="panel-title">רשימת יצרנים</h3>
			</div>
			<div class="panel-body">
				<div class="table">

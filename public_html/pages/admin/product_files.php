			...
			<div class="panel-body">
				<div class="form">
					<form id="formAddEditNewRow" method="post" action="" enctype="multipart/form-data"  role="form">
						...
						<div class="form-group" >
							<label for="label">טקסט באתר</label>
							<input type="text" class="form-control" id="label" name="label" placeholder="טקסט באתר" value="<?=$this->get_edited_data("label")?>">
						</div>
						<div class="form-group">
							<div class="checkbox">
								<label>
									<input type='hidden' value='0' name='mandatory'>
									<input type="checkbox" name="mandatory" value="1" <?=$this->is_checked("mandatory",1)?>> קובץ חובה
								</label>
							</div>
						</div>

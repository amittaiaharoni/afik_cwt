...
<div id="page_wraper" class="container-fluid" style="position: relative;">
			...
			<div class="panel-body">
				<div class="form">
					<form id="formAddEditNewRow" method="post" action="" enctype="multipart/form-data"  role="form">
						...
						<div class="form-group" >
							<label for="price">מחיר משלוח</label>
							<input type="text" class="form-control" id="price" name="price" placeholder="מחיר משלוח" value="<?=$this->get_edited_data("price")?>">
						</div>
						<div class="form-group" >
							<label for="area_id">אזור משלוח</label>
							<select name="area_id" class="form-control">
								<option value="0">בחר אזור משלוח</option>
								<?
								$areas = $this->data->deliveryArea->get_all();
								if (!emptY($areas)){
						...
						<div class="form-group" >
							<label for="branch_id">סניף</label>
							<select name="branch_id" class="form-control">
								...
								if (!emptY($branches)){
									...
									?>
									<option value="<?=$branch->id?>" <?=$this->is_selected("area_id",$branch->id)?>><?=$branch->name?></option>
									<?
									}
								}
								?>
	...
	<div id="" class="col-md-5">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="panel-title">רשימת מקומות משלוח</h3>
			</div>
			<div class="panel-body">
				<div class="table">

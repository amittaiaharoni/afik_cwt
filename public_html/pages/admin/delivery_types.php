...
<div id="page_wraper" class="container-fluid" style="position: relative;">
			...
			<div class="panel-body">
				<div class="form">
					<form id="formAddEditNewRow" method="post" action="" enctype="multipart/form-data"  role="form">
						...
						<div class="form-group" >
							<label for="from_order_amount">בקניה מ</label>
                            <input type="text" class="form-control" id="from_order_amount" name="from_order_amount" placeholder="בקניה מ" value="<?=$this->get_edited_data("from_order_amount")?>">
						</div>
						<div class="form-group" >
							<label for="new_delivery_from">מחיר משלוח חדש</label>
							<input type="text" class="form-control" id="new_delivery_from" name="new_delivery_from" placeholder="מחיר משלוח חדש" value="<?=$this->get_edited_data("new_delivery_from")?>">
						</div>
	...
	<div id="" class="col-md-5">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="panel-title">רשימת סוגי משלוח</h3>
			</div>
			<div class="panel-body">
				<div class="table">

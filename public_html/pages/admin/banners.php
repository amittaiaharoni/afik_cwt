...
/////////////////			FIELDS DEFINITION
				...
				{ "data": "name"},
				{
					...
					"orderable": false,
					"render": function ( data, type, full, meta ) {
					  return 	'<img src="<?=site_config::get_value('upload_thumbs_folder')?>'+data+'" stye="max-width: 70px; max-height: 50px;"/>';
					}
				},
////////////////////////////////////////////////////////////////////////
				// action buttons
...
<div id="page_wraper" class="container-fluid" style="position: relative;">
				...
				<div class="form">
					<form id="formAddEditNewRow" method="post" action="" enctype="multipart/form-data"  role="form">
						...
						<div class="form-group" >
							...
							<textarea name="html" id="html" class="form-control editor"><?=$this->get_edited_data("html")?></textarea>
						</div>
	...
	<div id="" class="col-md-5">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="panel-title">רשימת באנרים</h3>
			</div>
			<div class="panel-body">
				<div class="table">

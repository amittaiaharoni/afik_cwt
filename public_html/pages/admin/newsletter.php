...
<div id="page_wraper" class="container-fluid" style="position: relative;">
				...
				<div class="form">
					<form id="formAddEditNewRow" method="post" action="" enctype="multipart/form-data"  role="form">
						<div class="form-group" >
							...
							<input type="text" class="form-control" id="email" name="email" placeholder="מייל" value="<?=$this->get_edited_data("email")?>">
						</div>	
	...
	<div id="" class="col-md-5">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="panel-title">רשימת מיילים לNewsletter</h3>
			</div>
			<div class="panel-body">
				<div class="table">
